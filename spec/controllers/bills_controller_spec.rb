...
describe BillsController do
  ...
  let(:valid_attributes) { { "customer_id" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved bill as @bill" do
        ...
        post :create, {:bill => { "customer_id" => "invalid value" }}, valid_session
        assigns(:bill).should be_a_new(Bill)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested bill" do
        ...
        Bill.any_instance.should_receive(:update_attributes).with({ "customer_id" => "MyString" })
        put :update, {:id => bill.to_param, :bill => { "customer_id" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the bill as @bill" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Bill.any_instance.stub(:save).and_return(false)
        put :update, {:id => bill.to_param, :bill => { "customer_id" => "invalid value" }}, valid_session
        assigns(:bill).should eq(bill)
      end
